...
$outgoingServerAddress     = 'powerpackpaving.ca'; // consult your hosting provider.
...
$sendingAccountUsername    = 'info@powerpackpaving.ca';
$sendingAccountPassword    = '9054707544';

// Recipient (To:) Details - Change this to the email details of who will receive all the emails from the website.
$recipientEmail            = 'arvinalvea@gmail.com';      // Where to send the admin email.
$recipientName             = 'Anthony'; // Name of admin to receive email from website.

// Email details - Change these to suit your website needs
$emailSubject              = 'A message from a form on your website'; // Subject of the email that the admin will see.
$websiteName               = 'Power Pack Paving';       // This is used as the "From name".
